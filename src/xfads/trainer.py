...
def train_em(
    ...
    *,
    ...
    def eloss(e_modules, y, u, x, key) -> Scalar:
        return batch_loss(m_modules | e_modules, y, u, x, key, hyperparam)

    @eqx.filter_value_and_grad
    def mloss(m_modules, y, u, x, key) -> Scalar:
        return batch_loss(m_modules | e_modules, y, u, x, key, hyperparam)

    @eqx.filter_jit
    def estep(module, y, u, x, key, opt_state):
        loss, grads = eloss(module, y, u, x, key)
    ...
    @eqx.filter_jit
    def mstep(module, y, u, x, key, opt_state):
        loss, grads = mloss(module, y, u, x, key)
    ...
    for i in (pbar := trange(opt.max_outer_iter)):
        try:
            ...
            loss_e, e_modules, opt_state_estep = train_loop(
                e_modules, y, u, x, ekey, estep, opt_state_estep, opt
            )
            loss_m, m_modules, opt_state_mstep = train_loop(
                m_modules, y, u, x, mkey, mstep, opt_state_mstep, opt
            )
